...
class PenyakitController extends Controller
{
    ...
    {
        $gejalas = Gejala::all();
        return view('dashboard.penyakit-create', compact('penyakit', 'gejalas'));
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/dashboard/penyakit')->with('status', 'Data penyakit baru ditambahkan kedalam knowladge base.');
    }
    ...
    public function update(Request $request, Penyakit $penyakit)
    {
        ...
        return redirect('dashboard/penyakit')->with('status', 'Perubahan data disimpan kedalam knowladge base.');
    }
